...
const Services = () => {
  return (
   <div className='py-[28px]'>
     <Flex className=" flex-col md:flex-row  items-center  ">
        <div className=" md:pr-[60px] md:w-[50%]   ">
           <div className='md:flex md:justify-end'>
            ...
            <p className="md:w-[405px] w-auto font-primary font-medium text-[16px] text-[#6C6C6C] mb-[20px] md:mb-0">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
            </div>
           </div>
        </div>
    ...
    <Flex className=" flex-col md:flex-row items-center mt-2 md:mt-0">
        ...
        <div className="md:w-[50%]  relative bg-[url(./assets/servicethree.png)] bg-cover bg-center bg-no-repeat pt-[152px] pb-[144px] after:absolute after:content[''] after:top-0 after:left-0 after:h-full after:w-full after:bg-black/60 mt-2 md:mt-0">
